...
//            }
            ...
            graphic.setColor(Color.red);
            graphic.setFont(new Font("Calibri", Font.BOLD, 40));
    ...
    public void gameOver(Graphics graphic) {
        ...
        graphic.setFont(
                new Font("Calibri",
                        Font.BOLD,
                        30));
        FontMetrics metrics1 = getFontMetrics(graphic.getFont());
        graphic.drawString(
                "Score: " + applesEaten,
        ...
        graphic.setFont(
                new Font("Calibri",
                        Font.BOLD,
                        75));
        FontMetrics metrics2 = getFontMetrics(graphic.getFont());
        graphic.drawString(
                "Game Over",
